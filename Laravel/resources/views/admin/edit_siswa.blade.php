  ...
  <div class="card p-4 shadow-sm">
    ...
    <form action="{{ route('admin.update_siswa', $siswa->id) }}" method="POST">
      ...
      <div class="form-group mb-2">
        ...
        <input type="text" id="nama" name="name" value="{{ old('name', $siswa->name) }}" placeholder="Masukkan nama siswa" required class="form-control">
      </div>

      <div class="form-group mb-2">
        <label for="nisn">NISN</label>
        <input type="text" id="nisn" name="nisn" value="{{ old('nisn', $siswa->nisn) }}" placeholder="Masukkan NISN siswa" required class="form-control">
      </div>
      ...
      <div class="form-group mb-2">
        ...
        <input type="text" id="alamat" name="address" value="{{ old('address', $siswa->address) }}" placeholder="Masukkan alamat siswa" required class="form-control">
      </div>

      <div class="form-group mb-2">
        <label for="lahir">Tanggal Lahir</label>
        <input type="date" id="lahir" name="date_of_birth" value="{{ old('date_of_birth', $siswa->date_of_birth) }}" required class="form-control">
      </div>
